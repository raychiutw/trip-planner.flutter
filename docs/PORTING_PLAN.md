...
| TripsListScreen | TripsListPage（分類/搜尋/排序/action menu/JSON 匯入 第一波） | `GET /my-trips` rich summary（client-side filter/sort/search）、`DELETE /trips/:id`、`POST /trips/import`、現有 trips child routes |
