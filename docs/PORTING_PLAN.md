...
| GlobalMapScreen | placeholder（P1） | tab 佔位，顯示「即將推出」 |
...
lib/
  ...
  models/                   # trip / day / entry / poi / chat / notes / user…（fromJson + 等值）
  ...
  api/trip_repository.dart  # my-trips / trips / days / requests / notes / stats
