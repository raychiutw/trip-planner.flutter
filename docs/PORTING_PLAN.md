...
| TripsListScreen | TripsListPage（分類/搜尋/排序第一波） | `GET /my-trips` rich summary（client-side filter/sort/search）、`DELETE /trips/:id` |
