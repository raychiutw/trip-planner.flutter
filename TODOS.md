...
- [x] TripTimelineScreen 補 web parity:focus deep link、scroll-spy active day、今日自動定位、overflow actions、offline banner、segment 背景同步細節、行程切換 dropdown(**Completed:** feature/favorites-explore)
