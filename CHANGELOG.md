...
- **P0 地圖 parity**:TripMapScreen 新增 `/trips/:tripId/stop/:entryId/map` focus route，初載會切到 entry 所在日並聚焦該 pin；總覽點 pin 也會自動切到該 pin 所在 day；pin/card 點擊會同步 selected 狀態；overview/單日會依 day 畫出 route polyline。
